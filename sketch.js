...
function preload() {
  backgroundImg = loadImage("./assets/backimage.gif");
  backgroundMusic = loadSound("./assets/mixkit-game-show-fun-suspense-942.wav");
  computerSound = loadSound("./assets/mixkit-sword-slash-swoosh-1476.mp3");
  arrowSound = loadSound("./assets/mixkit-fast-sword-whoosh-2792.wav");
  collideSound = loadSound("./assets/mixkit-sword-strikes-armor-2765.wav");
  ...
  swal(
    {
      ...
      imageUrl:"https://raw.githubusercontent.com/Hemachandrasai/pop/main/stickman-archer-game.jpg",
      imageSize:"150x150",
  ...
  swal(
    {
      title:`You Win!!!`,
      text:"Thanks for playing!",
      imageUrl:"https://raw.githubusercontent.com/Hemachandrasai/win/main/pop.png",
      imageSize:"150x150",
      confirmButtonText: "Play Again"
